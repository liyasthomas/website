    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/materialthings.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          Material components are created with CSS, JavaScript, and HTML. You
          can use the components to construct web pages and web apps that are
          attractive, consistent, and functional. Pages developed with Material
          will adhere to modern web design principles like browser portability,
          device independence, and graceful degradation.
        </p>
      </div>
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://material-things.web.app"
          target="_blank"
          rel="noopener"
        >
        ...
        <a
          href="https://github.com/liyasthomas/material-things"
          target="_blank"
          rel="noopener"
        >
      ...
      <iron-ajax
        auto
        url="../data/materialthings_feeds.json"
        id="ajax0"
        loading="{{loading0}}"
        handle-as="json"
        last-error="{{error0}}"
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          ...
          applications using Web Components. The library is being developed by
          Google developers and contributors on GitHub. Modern design principles
          are implemented as a separate project using Google's Material Design
          design principles.
        </p>
        <p>
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          The Material Design system is designed to enable brand expression.
          It’s integrated with a custom code base that allows the seamless
          implementation of components, plug-ins, and design elements. ipsum
          dolor sit amet, consectetur adipisicing elit. Officiis, ipsum. Alias
          facilis illo, consequatur perspiciatis! Itaque ex dicta similique iste
          nostrum veritatis fugiat cupiditate magnam asperiores, laudantium sint
          vitae esse!
        </p>
        <p>
          Design and strategize how to build your app using Material Design
          architecture, while learning the principles and theory that underpin
          Material Design.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
