    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/konnect.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          College Intranet Application is for departmental utility management.
          It is a product built for solving the common problems
          colleges/schools/educational institutions face in developing a contact
          with the students and their caretakers on a regular basis. It has a
      ...
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://github.com/liyasthomas/konnect"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          A responsive notification system is one of the most crucial intranet
          features to consider. Notifications alert users about everything
          significant to their job, including tasks sent through a workflow,
          responses to a forum question, or department updates. The sooner
          students and faculties are notified about important information, the
          sooner they can take action.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Design and UI are related in many ways, but it's important to
          differentiate the two, as design focuses more on the visual look of
          your intranet than how it actually operates. Bearing this in mind, a
          well-designed intranet is one that is clean and minimalist in nature.
          A jumbled, unorganized, or messy intranet design will make even the
          best social intranet difficult to navigate and should be avoided at
          all costs.
        </p>
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          An intranet calendar is incredibly important to stay organized and
          track appointments, meetings, and events. Comprehensive intranet
          software will have a robust calendar system and allow you to easily
          log an event as simply or as detailed as you wish!
        </p>
        <p>
          Intranet document management lets employees upload documents to a
          repository or share them directly with certain individuals, and it
          comes along with as few data restrictions as possible.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
