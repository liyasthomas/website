          ...
          --app-grid-item-height: 100%;
			...
			<template is="dom-repeat" items="[[ajaxResponse0.android]]" as="android">
				<template is="dom-if" if="{{!error0}}">
					<div class="actions flex-justified">
						<div class="title">
							Popular&nbsp;<span>{{android.title}}</span>&nbsp;projects
						</div>
						<paper-icon-button
								hidden$="{{!wideLayout}}"
								toggles
			...
			<template is="dom-repeat" items="[[ajaxResponse0.web]]" as="web">
				<template is="dom-if" if="{{!error0}}">
					<div class="actions flex-justified">
						<div class="title">
							Popular&nbsp;<span>{{web.title}}</span>&nbsp;projects
						</div>
						<paper-icon-button
								hidden$="{{!wideLayout}}"
								toggles
			...
			<template is="dom-repeat" items="[[ajaxResponse0.other]]" as="other">
				<template is="dom-if" if="{{!error0}}">
					<div class="actions flex-justified">
						<div class="title">
							Popular&nbsp;<span>{{other.title}}</span>&nbsp;projects
						</div>
						<paper-icon-button
								hidden$="{{!wideLayout}}"
								toggles
