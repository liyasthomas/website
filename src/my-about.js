    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/about/banner.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          I'm a front end web designer/developer and 3D visualiser, skilled in
          HTML, CSS and CMS integration. I create clean, professional,
          functional websites.
        </p>
        <p>
          I've been designing websites professionally for over six years. And
          still loves every second of it.
        </p>
        <p>
        ...
        <p>
          At first I intended to be an artist and started creating art works.
        </p>
        <p>
          In high school, I was that kid that seemed to never be paying
          attention. Seemingly in my own world of doodles and drawings. I've had
          a pencil in my hand since I was in diapers. Things never change... I'm
          no longer in diapers though.
        </p>
        <p>
          <a href="mailto:liyascthomas@gmail.com?&subject=Hello Liyas!&body=Hi,"
            ><paper-button class="secondary" raised aria-label="Hire me"
              >Hire me<iron-icon
                icon="my-icons:alternate-email"
              ></iron-icon></paper-button
          ></a>
          <a href="projects"
            ><paper-button class="primary" aria-label="My projects"
              >My projects<iron-icon
                icon="my-icons:work"
              ></iron-icon></paper-button
          ></a>
        </p>
      ...
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          <a
            ...
            target="_blank"
            rel="noopener"
            ><paper-button class="secondary" aria-label="PayPal"
              >PayPal<iron-icon
      ...
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          <a href="projects"
            ><paper-button class="secondary" aria-label="My projects"
              >My projects<iron-icon
                icon="my-icons:work"
              ></iron-icon></paper-button
          ></a>
        ...
        <div class$="[[getUIType(UI)]] content">
          ...
          <p>
            <template is="dom-repeat" items="[[social.sub]]" as="sub">
              <a href="{{sub.link}}"
                ><paper-icon-button
                  src="../images/assets/social/{{sub.icon}}.svg"
                  aria-label="Icon"
                ></paper-icon-button
              ></a>
            </template>
          ...
          <p>
            <a href="https://liyasthomas.tumblr.com" target="_blank"
              ><paper-button class="secondary" aria-label="My Blog"
                >My Blog<iron-icon
