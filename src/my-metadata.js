    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/metadata.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          Metadata will show you all hidden metadata info of audio, video,
          document, ebook & image files.
        </p>
        <p>
          Just drag & drop or upload an image, document, video, audio or even
          e-book file. We will show you all metadata hidden inside the file!
        </p>
      </div>
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://github.com/liyasthomas/metadata"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Many files contain extra or even hidden data other than the visual
          data you see at first glance. E-books, photographs, movies, music and
          even documents can contain data that you don’t see at first glance.
        </p>
        <p>
          Photos contain exif data that can give you useful information about
          the picture. Information such as shutter speed and focal length are
          stored inside an image. Likewise, you can find out where the photo was
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Similar to photos, videos contain metadata info about the location
          where the video was shot. Likewise, container formats like AVI and MP4
          contain meta information about codecs, video and audio streams and
          more.
        </p>
        <p>
          Documents can contain metadata too. They include information such as
          file size and date of creation, but also information about the author
          of a document and the software used to create it.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Metadata reveals information of your files you may not be aware of.
        </p>
