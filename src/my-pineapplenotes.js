	...
	static get template() {
      ...
      <paper-dialog id="lightbox" class="lightboxdialog" on-click="toggleLightbox"></paper-dialog>
			<div class="banner flexchild flex-vertical">
				<iron-image preload fade sizing="contain" src="../images/assets/projects/pineapplenotes.svg" alt="Banner"></iron-image>
			</div>
			...
			<div class$="[[getUIType(UI)]] actions flex-center-center">
				<a href="https://pineapple-notes.firebaseapp.com" target="_blank" rel="noopener">
				...
				<a href="https://github.com/liyasthomas/pineapple-notes" target="_blank" rel="noopener">
					<paper-button class="primary" aria-label="GitHub">GitHub<iron-icon src="../images/assets/social/github.svg"></iron-icon></paper-button>
				</a>
			</div>
			<iron-ajax auto url="../data/pineapplenotes_feeds.json" id="ajax0" loading="{{loading0}}" handle-as="json" last-error="{{error0}}" last-response="{{ajaxResponse0}}">
			</iron-ajax>
