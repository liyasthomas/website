    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/fuseorg.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          Fuse Org is dedicated to assisting individual organizers of active
          mobile, web, cloud, and AI developer communities on their journey
          leading successful and engaged groups via online training, meetup
          materials, networking opportunities, and more.
        </p>
        <p>
          The community membership is free with no strings attached - we won’t
          ask you to promote our products, use our branding in events, or limit
          your work to any specific technologies, topics, or partners.
        </p>
      </div>
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        ...
        <a
          href="https://github.com/liyasthomas/fuse-org"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          As a member, you’ll get support to grow your network and community
          and, most importantly, support to grow as an individual leader. If you
          want a closer partnership with Fuse Org, you can optionally join the
          mailing list on top of the standard membership.
        </p>
        <p>
          Professional growth - Access to community management and technical
          knowledge to help you become a stronger leader.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Network growth - Opportunities to connect with other community
          leaders, industry experts, and devs to share knowledge.
        </p>
        <p>
          Community growth - Content, events, and best practices to assist you
          in building and engaging with your community.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
