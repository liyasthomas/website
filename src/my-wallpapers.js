    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/walls.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          ...
          Our phone wallpaper being the first thing we see, it can really
          influence our mood and it is also a great way to express our unique
          personality. We think it’s important that you can easily find
          inspiring and beautiful wallpapers that will make you happy and feel
          great every time you pick up your phone. Enjoy a collection that keeps
          on growing. Access images from Google Earth, Google+ and other
          partners.
        </p>
      </div>
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a href="https://photos.app.goo.gl/6kPov1TtR65cupPi8">
          <paper-button class="secondary" raised aria-label="View all"
            >View album<iron-icon icon="my-icons:arrow-forward"></iron-icon
          ></paper-button>
        </a>
      </div>
      <iron-ajax
        auto
        url="../data/wallpapers_feeds.json"
        id="ajax0"
        loading="{{loading0}}"
        handle-as="json"
        last-error="{{error0}}"
      ...
      <template
        is="dom-repeat"
        items="[[ajaxResponse0.wallpapers]]"
        as="wallpapers"
      >
        <div
        ...
        <div class$="[[getUIType(UI)]] app-grid" has-aspect-ratio>
          <template is="dom-repeat" items="[[wallpapers.sub]]" as="sub">
            <div
              class$="[[_computeTileClass(sub.color)]] item walls"
              on-click="toggleLightbox"
            >
              <div class="container">
      ...
      <template is="dom-repeat" items="[[ajaxResponse0.similar]]" as="similar">
        ...
        <div class$="[[getUIType(UI)]] actions flex-center-center">
          <a href="{{similar.link}}">
            <paper-button class="secondary" raised aria-label="View all"
              >View all {{similar.title}} projects</paper-button
            >
          </a>
        </div>
      </template>
