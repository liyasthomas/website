    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/marcdown.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          Marcdown syntax highlighting is unique. The refined text formatting of
          the editor helps you visualize the final rendering of your files.
        </p>
        <p>
          Markdown is a lightweight markup language, originally created by John
          Gruber and Aaron Swartz allowing people "to write using an
      ...
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        ...
        <a
          href="https://github.com/liyasthomas/marcdown"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          ...
          Preformatted text/Code blocks/Tables insert, Code fold, Search
          replace, Read only, Themes, Multi-languages, L18n, HTML entities, Code
          syntax highlighting.
        </p>
        <p>
      ...
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          WYSIWYG is an acronym for What You See Is What You Get. In computing,
          a WYSIWYG editor is a system in which content can be edited in a form
          closely resembling its appearance when printed or displayed as a
          finished product, such as a printed document, web page, or slide
          presentation.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Marcdown will give you a seamless experience as both a reader and a
          writer. It removes the preview window, mode switcher, syntax symbols
          of markdown source code, and all other unnecessary distractions.
          Replace them with a real live preview feature to help you concentrate
          on the content itself.
        </p>
        <p>
          Simple, yet Powerful - See how large your document is in unit of
