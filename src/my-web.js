...
class MyWeb extends PolymerElement {
	static get template() {
		return html `
			...
			<iron-ajax auto url="../data/web_feeds.json" id="ajax0" loading="{{loading0}}" handle-as="json" last-error="{{error0}}" on-response="_handleResponse" last-response="{{ajaxResponse0}}">
			</iron-ajax>
