        ...
        :host {
          ...
          --app-grid-item-height: 100%;
			...
			<div class="banner flexchild flex-vertical">
				<iron-image class="bg" preload fade sizing="contain" src="../images/assets/projects/undraw_onboarding_o8mv.svg"  alt="Banner"></iron-image>
			</div>
			...
			<template is="dom-repeat" items="[[ajaxResponse0.web]]" as="web">
				<div class$="[[getUIType(UI)]] content flex-justified">
					<paper-input class="searchInput" value="{{filterVal}}" placeholder="search for web projects" no-label-float>
