    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/stack.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          Stack is an addictive tower stacking game where you need quick
          reflexes. Of all the directions people like to go, up may be one of
          the most popular. In the aptly-named arcade game Stack your task is to
          build a tower upwards and as high as you can.
        </p>
      </div>
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://liyasthomas.github.io/stack"
          target="_blank"
          rel="noopener"
        >
        ...
        <a
          href="https://github.com/liyasthomas/stack"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Think you have the skills to perfectly stack these blocks as they
          build upwards? If you mess up, parts of them will fall off and they
          will speed up on stacking!
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          You have sliding building blocks going back and forth over your tower
          and you have to time it just right, so they fit perfectly on top of
          each other. If they don't, any overlap will be swiftly cut off, making
          the next level smaller and more difficult to stack blocks on.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Keep building and stacking until you miss, and boast to your friends
          about the amazing high score you reached in this online stack game.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
