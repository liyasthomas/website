    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/banner.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          Make banners where you can create your own banners in all sizes for
          free; you can either generate your banner from scratch or customize
          from pre-designed banners by changing the wording, overlays and
          pictures.
        </p>
      ...
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://liyasthomas.github.io/banner"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Forget all the hassle of working with complicated design tools. Learn
          how to make a banner within minutes!
        </p>
        <p>
          Create custom or standard ad sizes like Medium Rectangle, Large
          Rectangle, Leaderboard or Skyscraper for retargeting or acquisition.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Promote your e-commerce website or create the perfect product images
          to boost your online sales and revenue.
        </p>
        <p>
          Facebook cover and post images, Twitter headers, Youtube banners or
          Instagram visuals are only a few clicks away.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Enrich your user experience by creating personalized featured images,
          pop-ups or exit intent popups for your website or blog.
        </p>
        <p>
          Change and adapt any banner template to fit your exact needs. Our
          gallery is frequently updated with new and fresh designs.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
