    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/saapshot.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          • Saapshot is a fully featured and completely free Camera app for
          Android phones and tablets.
        </p>
        <p>
          • Option to auto-level so your pictures are perfectly level no matter
          what.
        </p>
        <p>
          • Expose your camera's functionality: support for focus modes, scene
          modes, color effects, white balance, ISO, exposure compensation/lock,
          face detection, torch, antibanding.
        </p>
        <p>• Zoom via multi-touch gesture and single-touch control.</p>
        <p>
          • Yes you can take a selfie (also known as front camera), includes
          support for "screen flash".
        </p>
      ...
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://liyasthomas.github.io/saapshot"
          target="_blank"
          rel="noopener"
        >
        ...
        <a
          href="https://github.com/liyasthomas/saapshot"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Never miss a moment with Saapshot, and take fantastic pictures using
          features such as Portrait and Night Sight.
        </p>
        <p>
          Take photos and record videos with your camera. An easy-to-use Camera
          app for taking photos and recording videos.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Transform photos with a click. Use simple, yet powerful, photo and
          video editing tools to apply filters, adjust colors, and more.
        </p>
        <p>
          A ccamera app to demonstrate camera functionality in the context of a
          Progressive Web App.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          All photos will remain strictly private, unless you choose to share
          them later.
        </p>
        <p>
          The app functions purely in your own web browser. If you do not choose
          to share your photos, they will remain only on your phone.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
