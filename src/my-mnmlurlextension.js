...
class MyMnmlurlextension extends PolymerElement {
  static get template() {
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/mnmlurlextension.svg"
          alt="Banner"
        ></iron-image>
      </div>
      ...
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://github.com/liyasthomas/mnmlurl-extension"
          target="_blank"
          rel="noopener"
        >
      ...
      <iron-ajax
        auto
        url="../data/mnmlurlextension_feeds.json"
        id="ajax0"
        loading="{{loading0}}"
        handle-as="json"
        last-error="{{error0}}"
...
window.customElements.define("my-mnmlurlextension", MyMnmlurlextension);
