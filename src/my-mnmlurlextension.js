	...
	static get template() {
      ...
      <paper-dialog id="lightbox" class="lightboxdialog" on-click="toggleLightbox"></paper-dialog>
			<div class="banner flexchild flex-vertical">
				<iron-image preload fade sizing="contain" src="../images/assets/projects/mnmlurlextension.svg" alt="Banner"></iron-image>
			</div>
			...
			<iron-ajax auto url="../data/mnmlurlextension_feeds.json" id="ajax0" loading="{{loading0}}" handle-as="json" last-error="{{error0}}" last-response="{{ajaxResponse0}}">
			</iron-ajax>
