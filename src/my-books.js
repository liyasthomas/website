    ...
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/books.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        ...
        <p>
          Book Search works just like web search. Try a search on Google Books
        ...
        <p>
          If the book is out of copyright, or the publisher has given us
          permission, you'll be able to see a preview of the book, and in some
          cases the entire text. If it's in the public domain, you're free to
          download a PDF copy.
        </p>
      </div>
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://liyasthomas.github.io/books"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          If you find a book you like, click on the "Buy this book" and "Borrow
          this book" links to see where you can buy or borrow the print book.
          You can now also buy the ebook from the Google Play Store.
        </p>
        <p>
          We've created reference pages for every book so you can quickly find
          all kinds of relevant information: book reviews, web references, maps
          and more.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          We respect the tremendous creative effort you put into your books.
          That's why we want to make it as easy as possible for people to find
          them.
        </p>
        <p>
          Project's aim is simple: make it easier for people to find relevant
          books – specifically, books they wouldn't find any other way such as
          those that are out of print – while carefully respecting authors' and
          publishers' copyrights. Our ultimate goal is to work with publishers
          and libraries to create a comprehensive, searchable, virtual card
          catalog of all books in all languages that helps users discover new
          books and publishers discover new readers.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Copyright law is supposed to ensure that authors and publishers have
          an incentive to create new work, not stop people from finding out that
          the work exists. By helping people find books, we believe we can
          increase the incentive to publish them. After all, if a book isn't
          discovered, it won't be bought.
        </p>
        <p>
          That's why we firmly believe that this project is good news for
          everybody who reads, writes, publishes and sells books.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
