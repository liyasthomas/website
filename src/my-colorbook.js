...
class MyColorbook extends PolymerElement {
  static get template() {
    return html`
      ...
      <div class="banner flexchild flex-vertical">
        <iron-image
          ...
          fade
          sizing="contain"
          src="../images/assets/projects/colorbook.svg"
          alt="Banner"
        ></iron-image>
      </div>
      <div class$="[[getUIType(UI)]] content">
        <div class="title">Colorbook</div>
        <div class="description">Color scheme for UI design</div>
        <p>
          Colorbook is an open-source color scheme optimized for UI like font,
          background, border, etc.
        </p>
        <p>1. Pick a color</p>
        <p>2. View demo</p>
        <p>3. Copy color codes</p>
      </div>
      <div class$="[[getUIType(UI)]] actions flex-center-center">
        <a
          href="https://liyasthomas.github.io/colorbook"
          target="_blank"
          rel="noopener"
        >
        ...
        <a
          href="https://github.com/liyasthomas/colorbook"
          target="_blank"
          rel="noopener"
        >
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>All colors shall have adequate use.</p>
        <p>Provide general color for UI design.</p>
        <p>All colors will be beautiful in itself and harmonious.</p>
        <p>
          At the same brightness level, the perceived brightness will be
          constant.
        </p>
        <p>
          The colors are subject to change in the future. Thus, using an Open
          color as a main identity color is not recommended.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>
          Colorbook is a complete color management solution geared towards
          motion picture production with an emphasis on visual effects and
          computer animation. OCIO provides a straightforward and consistent
      ...
      <div class$="[[getUIType(UI)]] content">
        <p>Generate perfect color combinations for your designs.</p>
        <p>
          The perception of a single color is different than perception of the
          very same color in combination with other colors. In the real world,
          it's very rare to see a single color. Usually we perceive a
          combination of multiple colors – some are dominant, some are minor,
          some are similar, close to each other – while others are contrast and
          accented. In graphic design it's not easy to pick up color
          combinations to create desired effect or emotion, though there are
          some techniques from the classical color theory helping us to find
          best supplements for a selected color.
        </p>
      </div>
      <template is="dom-if" if="{{loading0}}">
        <div
...
window.customElements.define("my-colorbook", MyColorbook);
